  ...
  return (
    <section
      ...
      style={{
        ...
        overflow: "hidden",
        background: "linear-gradient(160deg, #071209 0%, #0a1a0c 50%, #050e08 100%)",
      }}
    >
      <div aria-hidden style={{ position: "absolute", inset: 0, pointerEvents: "none", background: `
        ...
        radial-gradient(circle at 80% 30%, rgba(212,202,178,0.04) 0%, transparent 45%)
      `}}/>
      ...
      <div style={{ position: "relative", maxWidth: "72rem", margin: "0 auto", padding: "0 0.5rem" }}>
        ...
        >
          ...
          <h2 style={{
            ...
            fontSize: "clamp(2rem, 6vw, 3.75rem)", lineHeight: 1.1, marginBottom: "0.75rem",
            background: "linear-gradient(135deg, #f0fdf4 0%, #86efac 50%, #D4CAB2 100%)",
        ...
        <div style={{ 
          ...
          <div style={{ display: "flex", flexDirection: "column", gap: "1rem" }}>
            {INFO.map((item, i) => (
              <motion.div
                ...
                style={{
                  display: "flex", alignItems: "center", gap: "clamp(0.75rem, 3vw, 1.25rem)",
                  padding: "clamp(1rem, 3vw, 1.25rem) clamp(1rem, 4vw, 1.5rem)",
                  borderRadius: "1rem",
                  background: "linear-gradient(135deg, rgba(20,50,22,0.7), rgba(12,30,14,0.85))",
              ...
              >
                ...
                <div style={{ flex: 1, minWidth: 0 }}>
                  <p style={{ fontSize: "clamp(0.6rem, 2vw, 0.65rem)", fontWeight: 600, letterSpacing: "0.12em", color: "#4d7a54", fontFamily: "'DM Sans', sans-serif", textTransform: "uppercase", marginBottom: "0.2rem" }}>
                    {item.label}
                  </p>
                  {item.href ? (
                    <a href={item.href} target="_blank" rel="noopener noreferrer"
                      style={{ fontSize: "clamp(0.8rem, 2.5vw, 0.9rem)", color: "#d1fae5", fontFamily: "'DM Sans', sans-serif", textDecoration: "none", fontWeight: 500, wordBreak: "break-all" }}>
                      {item.value}
                    </a>
                  ) : (
            ...
            <motion.div
              ...
              style={{
                ...
                borderRadius: "1rem",
                background: "linear-gradient(135deg, rgba(20,55,25,0.7), rgba(12,32,15,0.85))",
            ...
            >
              ...
              <p style={{ fontSize: "clamp(0.75rem, 2.5vw, 0.82rem)", color: "#4d7a54", fontFamily: "'DM Sans', sans-serif", lineHeight: 1.6 }}>
                Full-time, freelance, remote and on-site. I respond within 24 hours.
              </p>
            </motion.div>
          </div>
          ...
          <motion.div
            ...
            style={{
              ...
              background: "linear-gradient(135deg, rgba(14,38,18,0.85), rgba(8,22,10,0.9))",
              border: "1px solid rgba(34,197,94,0.15)",
          ...
          >
            {status === "success" ? (
              <div style={{ textAlign: "center", padding: "clamp(2rem, 8vw, 3rem) 1rem" }}>
                ...
                <h3 style={{ fontFamily: "'Syne', sans-serif", fontWeight: 700, color: "#4ade80", fontSize: "clamp(1.2rem, 4vw, 1.4rem)", marginBottom: "0.5rem" }}>Message Sent!</h3>
                <p style={{ color: "#4d7a54", fontFamily: "'DM Sans', sans-serif", marginBottom: "1.5rem", fontSize: "clamp(0.85rem, 2.5vw, 0.95rem)" }}>I&apos;ll get back to you within 24 hours.</p>
                <button onClick={() => setStatus("idle")} style={{ background: "none", border: "none", color: "#4ade80", cursor: "pointer", textDecoration: "underline", fontSize: "clamp(0.8rem, 2.5vw, 0.875rem)" }}>
              ...
              <form onSubmit={handleSubmit} style={{ display: "flex", flexDirection: "column", gap: "1.25rem" }}>
                ...
                {status === "error" && (
                  <div style={{ display: "flex", gap: "0.5rem", color: "#f87171", fontSize: "clamp(0.75rem, 2vw, 0.8rem)", alignItems: "center" }}>
                ...
                <button
                  ...
                  style={{
                    width: "100%",
                    padding: "clamp(0.75rem, 2.5vw, 0.9rem) clamp(1rem, 4vw, 1.5rem)",
                    ...
                    gap: "0.6rem",
                    boxShadow: status === "loading" ? "none" : "0 4px 24px rgba(22,163,74,0.35)",
                    transition: "all 0.2s",
