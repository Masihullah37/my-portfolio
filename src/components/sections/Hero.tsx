...
const TECH_BADGES = [
  "TypeScript", "React.js", "Next.js 14", "Node.js",
  "Express.js", "Laravel", "PHP", "MySQL",
  "MongoDB", "Drizzle ORM", "Tailwind CSS", "Clerk Auth",
  "Gemini AI", "REST APIs", "GitHub Actions", "Vercel",
];
...
const FLIP_WORDS = ["Masihullah", "Full Stack Developer"];
      ...
      <AnimatePresence mode="wait">
        <motion.span
          ...
          style={{
            ...
            backgroundClip: "text",
            fontSize: "clamp(1.5rem, 5vw, inherit)",
          }}
        >
          {FLIP_WORDS[index]}
        </motion.span>
    ...
    >
      ...
      <div style={{
        ...
        <motion.div variants={containerVariants} initial="hidden" animate="show">
          ...
          <motion.div variants={itemVariants} style={{ display: "flex", justifyContent: "center", marginBottom: "clamp(1rem, 5vw, 2rem)" }}>
            <div style={{
              ...
              color: "#86efac", fontSize: "clamp(0.7rem, 3vw, 0.875rem)", fontWeight: 500,
              fontFamily: "'DM Sans', sans-serif",
              whiteSpace: "nowrap",
            }}>
              <span style={{ position: "relative", display: "flex", width: "8px", height: "8px", flexShrink: 0 }}>
                <span style={{ position: "absolute", display: "inline-flex", width: "100%", height: "100%", borderRadius: "50%", background: "#4ade80", opacity: 0.75, animation: "pulse-ring 1.5s ease-out infinite" }} />
              ...
              <span style={{ whiteSpace: "normal", wordBreak: "keep-all" }}>Available for new opportunities</span>
            </div>
          </motion.div>
          ...
          <motion.p variants={itemVariants} style={{
            ...
            color: "#4d7a54", marginBottom: "1rem", fontWeight: 300,
            fontFamily: "'DM Sans', sans-serif",
            padding: "0 0.5rem",
          }}>
            Full Stack Developer &nbsp;·&nbsp;{" "}
            <span style={{ color: "#4ade80", display: "inline-block" }}>Building modern web experiences</span>
          </motion.p>

          <motion.p variants={itemVariants} style={{
            maxWidth: "38rem", margin: "0 auto 2rem",
            color: "#374c38", lineHeight: 1.6,
            fontSize: "clamp(0.8rem, 2.5vw, 1.05rem)",
            fontFamily: "'DM Sans', sans-serif",
            padding: "0 0.75rem",
          }}>
            I craft fast, scalable web applications using React, Next.js, Laravel, and Node.js.
            Passionate about clean code and solving real problems with great user experiences.
          </motion.p>
          ...
          <motion.div variants={itemVariants} style={{
            ...
            <a href="#projects" style={{
              ...
              color: "white", fontWeight: 600, fontSize: "clamp(0.8rem, 2.5vw, 0.9rem)",
              textDecoration: "none",
              ...
              onMouseEnter={e => { (e.currentTarget as HTMLElement).style.boxShadow = "0 0 0 1px rgba(74,222,128,0.6), 0 8px 40px rgba(22,163,74,0.45)"; }}
              onMouseLeave={e => { (e.currentTarget as HTMLElement).style.boxShadow = "0 0 0 1px rgba(22,163,74,0.5), 0 8px 32px rgba(22,163,74,0.3)"; }}
            >
              View My Work
            </a>
            <a href="#contact" style={{
              ...
              border: "1px solid rgba(34,197,94,0.3)",
              color: "#86efac", fontWeight: 600, fontSize: "clamp(0.8rem, 2.5vw, 0.9rem)",
              textDecoration: "none", backdropFilter: "blur(12px)",
              transition: "all 0.2s",
              fontFamily: "'DM Sans', sans-serif",
              whiteSpace: "nowrap",
            }}
              onMouseEnter={e => { (e.currentTarget as HTMLElement).style.borderColor = "rgba(74,222,128,0.5)"; (e.currentTarget as HTMLElement).style.color = "#d1fae5"; }}
              onMouseLeave={e => { (e.currentTarget as HTMLElement).style.borderColor = "rgba(34,197,94,0.3)"; (e.currentTarget as HTMLElement).style.color = "#86efac"; }}
            >
              Get In Touch
            </a>
          </motion.div>
            ...
            {SOCIAL_LINKS.map(({ icon: Icon, href, label, isExternal }) => (
              <motion.a
                ...
                style={{
                  ...
                  color: "#374c38", backdropFilter: "blur(12px)",
